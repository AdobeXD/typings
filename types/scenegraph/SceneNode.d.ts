...
export abstract class SceneNode {
     ...
     * 
     * @param deltaX Amount to move along X axis
     * @param deltaY Amount to move along Y axis
     * @param deltaZ Optional: number of pixels to change depth with
     */
     ...
     * For an overview of node positioning & coordinate systems, see Coordinate spaces.
     * @param registrationPoint Point in this node’s local coordinate space to align with parentPoint
     * @param parentPoint Point in this node’s parent’s coordinate space to move registrationPoint to
     */
